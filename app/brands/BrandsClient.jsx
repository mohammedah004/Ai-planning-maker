        ...
        {brands.length === 0 ? (
            ...
            <div className="rounded-3xl border border-dashed border-[#E4E7EC] bg-[#F8F9FB] dark:border-zinc-800 dark:bg-zinc-900/30 p-12 text-center max-w-xl mx-auto my-12 space-y-4">
              ...
              <div className="space-y-1">
                <h3 className="text-lg font-bold text-[#1A1D1F] dark:text-zinc-100">لا توجد ملفات براند محفوظة</h3>
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div className="space-y-1">
                          <div className="flex items-center gap-2">
                            ...
                            {brand.is_default && (
                              <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-blue-50 border border-blue-200 text-[#0B57D0] dark:bg-blue-950/60 dark:border-blue-800/60 dark:text-blue-300 text-[10px] font-bold">
