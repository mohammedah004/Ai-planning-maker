...
export default function Sidebar({ user = null, brandCount = null, className = "" }) {
  return (
    <aside
      ...
      className={`
        w-64 lg:w-72 h-screen sticky top-0 flex flex-col justify-between p-5 border-l border-zinc-800/80 bg-[#0c0c0f] shrink-0 text-right select-none
        ${className}
      `.trim()}
    >
      ...
      <div className="space-y-6">
        ...
        >
          ...
          <div className="space-y-0.5 min-w-0">
            <div className="text-sm font-extrabold text-zinc-100 tracking-tight leading-none group-hover:text-blue-400 transition-colors">
              مخطط التسويق الذكي
            </div>
            <div className="text-[11px] text-zinc-500 font-medium leading-none">
