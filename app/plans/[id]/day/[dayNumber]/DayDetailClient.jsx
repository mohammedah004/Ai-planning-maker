    ...
    <AppShell>
      <div className="w-full max-w-5xl mx-auto space-y-8 text-right">
        {loading ? (
          ...
          <div className="p-8 sm:p-10 rounded-3xl bg-[#131316] border border-red-800/80 text-center space-y-4 max-w-xl mx-auto my-12 shadow-2xl">
            <AlertCircle className="w-10 h-10 text-red-400 mx-auto" />
            <h2 className="text-lg font-bold text-zinc-100">حدث خطأ أثناء تحميل تفاصيل اليوم</h2>
            <p className="text-xs text-red-300 max-w-md mx-auto leading-relaxed">{error}</p>
            <div className="pt-2">
          ...
          <div className="p-8 sm:p-10 rounded-3xl bg-[#131316] border border-zinc-800 text-center space-y-4 max-w-xl mx-auto my-12 shadow-2xl">
            <AlertCircle className="w-10 h-10 text-amber-400 mx-auto" />
            <h2 className="text-lg font-bold text-zinc-100">منشور اليوم {dayNumber} غير موجود</h2>
