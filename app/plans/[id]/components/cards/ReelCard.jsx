...
export default function ReelCard({
  ...
  return (
    <div
      className={`
        group relative flex flex-col justify-between rounded-2xl bg-[#F8F9FB] dark:bg-[#131316] border border-[#E4E7EC] dark:border-zinc-800/90 hover:border-purple-500/60 hover:shadow-md transition-all duration-200 text-right overflow-hidden shadow-xs
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          ...
          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-lg bg-purple-50 border border-purple-200 text-purple-700 dark:bg-purple-950/60 dark:border-purple-800/60 dark:text-purple-300 text-[11px] font-bold">
