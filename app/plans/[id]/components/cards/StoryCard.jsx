...
export default function StoryCard({
  ...
  return (
    <div
      className={`
        group relative flex flex-col justify-between rounded-2xl bg-white dark:bg-[#131316] border border-slate-200/80 dark:border-zinc-800/90 hover:border-amber-500/60 hover:shadow-md transition-all duration-200 text-right overflow-hidden shadow-xs
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          ...
          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-lg bg-amber-50/70 border border-amber-200/70 text-amber-800 dark:bg-amber-950/60 dark:border-amber-800/60 dark:text-amber-300 text-[11px] font-bold">
        ...
        {!readOnly && onRegenerate && (
          <button
            ...
            className="opacity-0 group-hover:opacity-100 p-1.5 rounded-lg bg-white hover:bg-amber-50 text-slate-600 hover:text-amber-800 border border-slate-200 dark:bg-zinc-800 dark:hover:bg-amber-950/60 dark:text-zinc-400 dark:hover:text-amber-300 dark:border-zinc-700 transition-all cursor-pointer shadow-xs"
          >
      ...
      >
        ...
        >
          ...
          <div className="my-auto space-y-1">
            <p className="text-xs font-bold text-slate-900 dark:text-zinc-100 line-clamp-2 leading-relaxed">
              {hook}
            </p>
          </div>

          {/* Interactive Story Sticker / Reply Cue */}
          <div className="flex items-center justify-between text-[10px] text-amber-800 dark:text-amber-400 font-medium pt-1 border-t border-amber-200 dark:border-amber-900/30">
        ...
        {!isMini && (
          <div className="flex flex-wrap items-center justify-between gap-2 pt-1 text-[11px] text-slate-600 dark:text-zinc-400">
            ...
            <span className="inline-flex items-center gap-1 text-amber-800 dark:text-amber-400 group-hover:text-amber-900 dark:group-hover:text-amber-300 font-bold transition-colors">
